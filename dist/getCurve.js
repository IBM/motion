...
var getCurve = function getCurve() {
	...
	var _constants$PROPERTY_F, _constants$PROPERTY_M, _constants$PROPERTY_R, _;
	...
	}), _constants$PROPERTY_M)), (0, _defineProperty3.default)(_, _constants2.default.PROPERTY_ROTATE, (_constants$PROPERTY_R = {}, (0, _defineProperty3.default)(_constants$PROPERTY_R, _constants2.default.MOMENT_CELEBRATORY, {
		curves: {
			easeInOut: 'cubic-bezier(0.4, 0.14, 0.3, 1)',
			easeIn: 'cubic-bezier(0.4, 0.14, 1, 1)',
			easeOut: 'cubic-bezier(0, 0, 0.3, 1)'
		}
	}), (0, _defineProperty3.default)(_constants$PROPERTY_R, _constants2.default.MOMENT_PRODUCTIVE, {
		curves: {
			easeInOut: 'cubic-bezier(0.2, 0.2, 0.38, 0.9)',
			easeIn: 'cubic-bezier(0.2, 0.1, 1, 1)',
			easeOut: 'cubic-bezier(0, 0, 0.38, 0.9)'
		}
	}), _constants$PROPERTY_R)), _))['7'][property === _constants2.default.PROPERTY_SCALE || property === _constants2.default.PROPERTY_ROTATE ? _constants2.default.PROPERTY_MOVE : property][motionMode].curves[easing];
};
